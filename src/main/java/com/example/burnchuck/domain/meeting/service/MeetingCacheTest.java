...
public class MeetingCacheTest {
     ...
     */
    public List<Long> findMeetingsByLocation(Location location, double radius) {

        Circle searchArea = new Circle(new Point(location.getLongitude(), location.getLatitude()), new Distance(radius, RedisGeoCommands.DistanceUnit.KILOMETERS));
